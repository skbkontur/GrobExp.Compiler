...
namespace GrobExp.Compiler.Tests
{
    ...
    public class TestConvertChecked
    {
        ...
        {
            ClassicAssert.AreEqual(-13, Convert<sbyte, int>(-13));
            Assert.Throws<OverflowException>(() => Convert<sbyte, uint>(-13));
            ClassicAssert.AreEqual(-13, Convert<sbyte, sbyte>(-13));
            Assert.Throws<OverflowException>(() => Convert<sbyte, byte>(-13));
            ClassicAssert.AreEqual(-13, Convert<sbyte, short>(-13));
            Assert.Throws<OverflowException>(() => Convert<sbyte, ushort>(-13));
            ClassicAssert.AreEqual(-13, Convert<sbyte, long>(-13));
            Assert.Throws<OverflowException>(() => Convert<sbyte, ulong>(-13));
            ClassicAssert.AreEqual((float)(-13), Convert<sbyte, float>(-13));
            ClassicAssert.AreEqual((double)(-13), Convert<sbyte, double>(-13));
        }
        ...
        {
            ClassicAssert.AreEqual(13, Convert<sbyte, int>(13));
            ClassicAssert.AreEqual((sbyte)13, Convert<sbyte, uint>(13));
            ClassicAssert.AreEqual(13, Convert<sbyte, sbyte>(13));
            ClassicAssert.AreEqual(13, Convert<sbyte, byte>(13));
            ClassicAssert.AreEqual(13, Convert<sbyte, short>(13));
            ClassicAssert.AreEqual(13, Convert<sbyte, ushort>(13));
            ClassicAssert.AreEqual(13, Convert<sbyte, long>(13));
            ClassicAssert.AreEqual((sbyte)13, Convert<sbyte, ulong>(13));
            ClassicAssert.AreEqual((float)13, Convert<sbyte, float>(13));
            ClassicAssert.AreEqual((double)13, Convert<sbyte, double>(13));
        }
        ...
        {
            ClassicAssert.AreEqual(-13, Convert<short, int>(-13));
            Assert.Throws<OverflowException>(() => Convert<short, uint>(-13));
            ClassicAssert.AreEqual(-13, Convert<short, sbyte>(-13));
            Assert.Throws<OverflowException>(() => Convert<short, sbyte>(-1000));
            Assert.Throws<OverflowException>(() => Convert<short, byte>(-13));
            ClassicAssert.AreEqual(-13, Convert<short, short>(-13));
            Assert.Throws<OverflowException>(() => Convert<short, ushort>(-13));
            ClassicAssert.AreEqual(-13, Convert<short, long>(-13));
            Assert.Throws<OverflowException>(() => Convert<short, ulong>(-13));
            ClassicAssert.AreEqual((float)(-13), Convert<short, float>(-13));
            ClassicAssert.AreEqual((double)(-13), Convert<short, double>(-13));
        }
        ...
        {
            ClassicAssert.AreEqual(13, Convert<short, int>(13));
            ClassicAssert.AreEqual((short)13, Convert<short, uint>(13));
            ClassicAssert.AreEqual(13, Convert<short, sbyte>(13));
            Assert.Throws<OverflowException>(() => Convert<short, sbyte>(200));
            Assert.Throws<OverflowException>(() => Convert<short, byte>(300));
            ClassicAssert.AreEqual(13, Convert<short, byte>(13));
            ClassicAssert.AreEqual(13, Convert<short, short>(13));
            ClassicAssert.AreEqual(13, Convert<short, ushort>(13));
            ClassicAssert.AreEqual(13, Convert<short, long>(13));
            ClassicAssert.AreEqual((short)13, Convert<short, ulong>(13));
            ClassicAssert.AreEqual((float)13, Convert<short, float>(13));
            ClassicAssert.AreEqual((double)13, Convert<short, double>(13));
        }
        ...
        {
            ClassicAssert.AreEqual(13, Convert<int, int>(13));
            ClassicAssert.AreEqual(13, Convert<int, uint>(13));
            ClassicAssert.AreEqual(13, Convert<int, sbyte>(13));
            Assert.Throws<OverflowException>(() => Convert<int, sbyte>(200));
            ClassicAssert.AreEqual(13, Convert<int, byte>(13));
            Assert.Throws<OverflowException>(() => Convert<int, sbyte>(300));
            ClassicAssert.AreEqual(13, Convert<int, short>(13));
            Assert.Throws<OverflowException>(() => Convert<int, short>(33000));
            ClassicAssert.AreEqual(13, Convert<int, ushort>(13));
            Assert.Throws<OverflowException>(() => Convert<int, short>(66000));
            ClassicAssert.AreEqual(13, Convert<int, long>(13));
            ClassicAssert.AreEqual(13, Convert<int, ulong>(13));
            ClassicAssert.AreEqual((float)13, Convert<int, float>(13));
            ClassicAssert.AreEqual((double)13, Convert<int, double>(13));
        }
        ...
        {
            ClassicAssert.AreEqual(250, Convert<byte, int>(250));
            ClassicAssert.AreEqual(250, Convert<byte, uint>(250));
            Assert.Throws<OverflowException>(() => Convert<byte, sbyte>(250));
            ClassicAssert.AreEqual(250, Convert<byte, byte>(250));
            ClassicAssert.AreEqual(250, Convert<byte, short>(250));
            ClassicAssert.AreEqual(250, Convert<byte, ushort>(250));
            ClassicAssert.AreEqual(250, Convert<byte, long>(250));
            ClassicAssert.AreEqual(250, Convert<byte, ulong>(250));
            ClassicAssert.AreEqual((float)250, Convert<byte, float>(250));
            ClassicAssert.AreEqual((double)250, Convert<byte, double>(250));
        }

        [Test]
        public void TestUInt16()
        {
            ClassicAssert.AreEqual(54321, Convert<ushort, int>(54321));
            ClassicAssert.AreEqual(54321, Convert<ushort, uint>(54321));
            ...
            ClassicAssert.AreEqual(54321, Convert<ushort, ushort>(54321));
            ClassicAssert.AreEqual(54321, Convert<ushort, long>(54321));
            ClassicAssert.AreEqual(54321, Convert<ushort, ulong>(54321));
            ClassicAssert.AreEqual((float)54321, Convert<ushort, float>(54321));
            ClassicAssert.AreEqual((double)54321, Convert<ushort, double>(54321));
        }
        ...
        public void TestUInt32()
        {
            ...
            ClassicAssert.AreEqual(3000000000, Convert<uint, uint>(3000000000));
            ...
            ClassicAssert.AreEqual(3000000000, Convert<uint, long>(3000000000));
            ClassicAssert.AreEqual(3000000000, Convert<uint, ulong>(3000000000));
            ClassicAssert.AreEqual((float)3000000000, Convert<uint, float>(3000000000));
            ClassicAssert.AreEqual((double)3000000000, Convert<uint, double>(3000000000));
        }
        ...
        public void TestUInt64()
        {
            unchecked
            {
                ...
                ClassicAssert.AreEqual(10000000000000000000, Convert<ulong, ulong>(10000000000000000000));
                ClassicAssert.AreEqual((float)10000000000000000000, Convert<ulong, float>(10000000000000000000));
                ClassicAssert.AreEqual((double)10000000000000000000, Convert<ulong, double>(10000000000000000000));
            }
        }
        ...
        public void TestInt64Positive()
        {
            ...
            ClassicAssert.AreEqual(1000000000000000000, Convert<long, long>(1000000000000000000));
            ClassicAssert.AreEqual(1000000000000000000, Convert<long, ulong>(1000000000000000000));
            ClassicAssert.AreEqual((float)1000000000000000000, Convert<long, float>(1000000000000000000));
            ClassicAssert.AreEqual((double)1000000000000000000, Convert<long, double>(1000000000000000000));
        }
        ...
        public void TestInt64Negative()
        {
            unchecked
            {
                ClassicAssert.AreEqual((long)(-13), Convert<long, int>(-13));
                Assert.Throws<OverflowException>(() => Convert<long, int>(-3000000000));
                Assert.Throws<OverflowException>(() => Convert<long, uint>(-13));
                ClassicAssert.AreEqual((long)(-13), Convert<long, sbyte>(-13));
                Assert.Throws<OverflowException>(() => Convert<long, sbyte>(-130));
                Assert.Throws<OverflowException>(() => Convert<long, byte>(-13));
                ClassicAssert.AreEqual((long)(-13), Convert<long, short>(-13));
                Assert.Throws<OverflowException>(() => Convert<long, short>(-33000));
                Assert.Throws<OverflowException>(() => Convert<long, ushort>(-13));
                ClassicAssert.AreEqual(-13, Convert<long, long>(-13));
                Assert.Throws<OverflowException>(() => Convert<long, ulong>(-13));
                ClassicAssert.AreEqual((float)(-13), Convert<long, float>(-13));
                ClassicAssert.AreEqual((double)(-13), Convert<long, double>(-13));
            }
        }
