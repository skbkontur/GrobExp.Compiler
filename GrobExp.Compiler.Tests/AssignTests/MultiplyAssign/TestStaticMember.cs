...
namespace GrobExp.Compiler.Tests.AssignTests.MultiplyAssign
{
    ...
    public class TestStaticMember
    {
        ...
        public void TestProp()
        {
            ...
            ClassicAssert.AreEqual(6, f(-3));
            ClassicAssert.AreEqual(6, TestClassA.IntProp);
            TestClassA.IntProp = -2;
            ClassicAssert.AreEqual(-20, f(10));
            ClassicAssert.AreEqual(-20, TestClassA.IntProp);
        ...
        public void TestField()
        {
            ...
            ClassicAssert.AreEqual(2, f(2));
            ClassicAssert.AreEqual(2, TestClassA.IntField);
            TestClassA.IntField = -2;
            ClassicAssert.AreEqual(6, f(-3));
            ClassicAssert.AreEqual(6, TestClassA.IntField);
            TestClassA.IntField = -2;
            ClassicAssert.AreEqual(-20, f(10));
            ClassicAssert.AreEqual(-20, TestClassA.IntField);
        ...
        public void TestNullable()
        {
            ...
            ClassicAssert.AreEqual(6, f(-3));
            ClassicAssert.AreEqual(6, TestClassA.NullableIntProp);
            TestClassA.NullableIntProp = -2;
            ClassicAssert.AreEqual(-20, f(10));
            ClassicAssert.AreEqual(-20, TestClassA.NullableIntProp);
        ...
        public void TestCheckedUnsigned()
        {
            ...
            ClassicAssert.AreEqual(4000000000, f(2));
            ClassicAssert.AreEqual(4000000000, TestClassA.UIntField);
            TestClassA.UIntField = 2000000000;
        ...
        public void TestCheckedNullableUnsigned()
        {
            ...
            ClassicAssert.AreEqual(2, f(2));
            ClassicAssert.AreEqual(2, TestClassA.NullableUIntField);
            TestClassA.NullableUIntField = 2000000000;
            ClassicAssert.AreEqual(4000000000, f(2));
            ClassicAssert.AreEqual(4000000000, TestClassA.NullableUIntField);
            TestClassA.NullableUIntField = 2000000000;
            Assert.Throws<OverflowException>(() => f(3));
