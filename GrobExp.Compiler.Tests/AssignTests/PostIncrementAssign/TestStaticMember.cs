...
namespace GrobExp.Compiler.Tests.AssignTests.PostIncrementAssign
{
    ...
    public class TestStaticMember
    {
        ...
        {
            Expression<Func<int>> exp = Expression.Lambda<Func<int>>(Expression.PostIncrementAssign(Expression.MakeMemberAccess(null, typeof(TestClassA).GetProperty("IntProp"))));
            ...
            ClassicAssert.AreEqual(int.MinValue, TestClassA.IntProp);
        }

        [Test]
        public void TestDoubleField()
        {
            Expression<Func<double>> exp = Expression.Lambda<Func<double>>(Expression.PostIncrementAssign(Expression.MakeMemberAccess(null, typeof(TestClassA).GetField("DoubleField"))));
            var f = LambdaCompiler.Compile(exp, CompilerOptions.CheckNullReferences);
        ...
        {
            Expression<Func<int?>> exp = Expression.Lambda<Func<int?>>(Expression.PostIncrementAssign(Expression.MakeMemberAccess(null, typeof(TestClassA).GetProperty("NullableIntProp"))));
            ...
            ClassicAssert.AreEqual(int.MaxValue, f());
            ClassicAssert.AreEqual(int.MinValue, TestClassA.NullableIntProp);
