...
namespace GrobExp.Compiler.Tests.AssignTests.PreIncrementAssign
{
    ...
    public class TestComplexProperty
    {
        ...
        public void TestInt()
        {
            ...
            Expression<Func<TestClassA, int>> exp = Expression.Lambda<Func<TestClassA, int>>(Expression.PreIncrementAssign(Expression.MakeIndex(Expression.MakeMemberAccess(a, typeof(TestClassA).GetProperty("IntArray")), typeof(IntArray).GetProperty("Item"), new[] {Expression.Constant("zzz"), Expression.Constant(1)})), a);
            ...
            ClassicAssert.AreEqual(int.MinValue, o.IntArray["zzz", 1]);
        ...
        public void TestNullable()
        {
            ...
            ClassicAssert.AreEqual(int.MinValue, f(o));
            ClassicAssert.AreEqual(int.MinValue, o.NullableIntArray["zzz", 1]);
        ...
        {
            ParameterExpression a = Expression.Parameter(typeof(TestClassA), "a");
            Expression<Func<TestClassA, double>> exp = Expression.Lambda<Func<TestClassA, double>>(Expression.PreIncrementAssign(Expression.MakeIndex(Expression.MakeMemberAccess(a, typeof(TestClassA).GetField("DoubleArray")), typeof(DoubleArray).GetProperty("Item"), new[] {Expression.Constant("zzz"), Expression.Constant(1)})), a);
            var f = LambdaCompiler.Compile(exp, CompilerOptions.CheckNullReferences);
