...
namespace GrobExp.Compiler.Tests.AssignTests.PreDecrementAssign
{
    ...
    public class TestSimpleArray
    {
        ...
        public void TestInt()
        {
            ...
            Expression<Func<TestClassA, int>> exp = Expression.Lambda<Func<TestClassA, int>>(Expression.PreDecrementAssign(Expression.ArrayAccess(Expression.MakeMemberAccess(a, typeof(TestClassA).GetProperty("IntArray")), Expression.Constant(0))), a);
        ...
        {
            ParameterExpression a = Expression.Parameter(typeof(TestClassA), "a");
            Expression<Func<TestClassA, int?>> exp = Expression.Lambda<Func<TestClassA, int?>>(Expression.PreDecrementAssign(Expression.ArrayAccess(Expression.MakeMemberAccess(a, typeof(TestClassA).GetProperty("NullableIntArray")), Expression.Constant(0))), a);
            var f = LambdaCompiler.Compile(exp, CompilerOptions.CheckNullReferences);
        ...
        {
            ParameterExpression a = Expression.Parameter(typeof(TestClassA), "a");
            Expression<Func<TestClassA, double>> exp = Expression.Lambda<Func<TestClassA, double>>(Expression.PreDecrementAssign(Expression.ArrayAccess(Expression.MakeMemberAccess(a, typeof(TestClassA).GetField("DoubleArray")), Expression.Constant(0))), a);
            var f = LambdaCompiler.Compile(exp, CompilerOptions.CheckNullReferences);
