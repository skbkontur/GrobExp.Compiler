...
namespace GrobExp.Compiler.Tests.AssignTests.OrAssign
{
    ...
    public class TestComplexProperty
    {
        ...
        public void TestInt()
        {
            ...
            Expression<Func<TestClassA, int, int>> exp = Expression.Lambda<Func<TestClassA, int, int>>(Expression.OrAssign(Expression.MakeIndex(Expression.MakeMemberAccess(a, typeof(TestClassA).GetProperty("IntArray")), typeof(IntArray).GetProperty("Item"), new[] {Expression.Constant("zzz"), Expression.Constant(1)}), b), a, b);
            var f = LambdaCompiler.Compile(exp, CompilerOptions.CheckNullReferences);
            var o = new TestClassA {IntArray = new IntArray()};
            o.IntArray["zzz", 1] = 0;
            ClassicAssert.AreEqual(123, f(o, 123));
            ClassicAssert.AreEqual(123, o.IntArray["zzz", 1]);
            o.IntArray["zzz", 1] = 5;
            ClassicAssert.AreEqual(7, f(o, 3));
            ClassicAssert.AreEqual(7, o.IntArray["zzz", 1]);
            o.IntArray["zzz", 1] = 17235476;
            ClassicAssert.AreEqual(17235476 | 73172563, f(o, 73172563));
            ClassicAssert.AreEqual(17235476 | 73172563, o.IntArray["zzz", 1]);
        ...
        public void TestNullable()
        {
            ParameterExpression a = Expression.Parameter(typeof(TestClassA), "a");
            ParameterExpression b = Expression.Parameter(typeof(int?), "b");
            Expression<Func<TestClassA, int?, int?>> exp = Expression.Lambda<Func<TestClassA, int?, int?>>(Expression.OrAssign(Expression.MakeIndex(Expression.MakeMemberAccess(a, typeof(TestClassA).GetField("NullableIntArray")), typeof(NullableIntArray).GetProperty("Item"), new[] {Expression.Constant("zzz"), Expression.Constant(1)}), b), a, b);
            var f = LambdaCompiler.Compile(exp, CompilerOptions.CheckNullReferences);
            var o = new TestClassA {NullableIntArray = new NullableIntArray()};
            o.NullableIntArray["zzz", 1] = 0;
            ClassicAssert.AreEqual(123, f(o, 123));
            ClassicAssert.AreEqual(123, o.NullableIntArray["zzz", 1]);
            o.NullableIntArray["zzz", 1] = 5;
            ClassicAssert.AreEqual(7, f(o, 3));
            ClassicAssert.AreEqual(7, o.NullableIntArray["zzz", 1]);
            o.NullableIntArray["zzz", 1] = 17235476;
            ClassicAssert.AreEqual(17235476 | 73172563, f(o, 73172563));
            ClassicAssert.AreEqual(17235476 | 73172563, o.NullableIntArray["zzz", 1]);
