...
namespace GrobExp.Compiler.Tests.AssignTests.PostDecrementAssign
{
    ...
    public class TestStaticMember
    {
        ...
        {
            Expression<Func<int>> exp = Expression.Lambda<Func<int>>(Expression.PostDecrementAssign(Expression.MakeMemberAccess(null, typeof(TestClassA).GetProperty("IntProp"))));
            ...
            ClassicAssert.AreEqual(int.MinValue, f());
        ...
        {
            Expression<Func<double>> exp = Expression.Lambda<Func<double>>(Expression.PostDecrementAssign(Expression.MakeMemberAccess(null, typeof(TestClassA).GetField("DoubleField"))));
            var f = LambdaCompiler.Compile(exp, CompilerOptions.CheckNullReferences);
        ...
        {
            Expression<Func<int?>> exp = Expression.Lambda<Func<int?>>(Expression.PostDecrementAssign(Expression.MakeMemberAccess(null, typeof(TestClassA).GetProperty("NullableIntProp"))));
