...
namespace GrobExp.Compiler.Tests.AssignTests.LeftShiftAssign
{
    ...
    public class TestMultiDimensionalArray
    {
        ...
        public void Test1()
        {
            ...
            ClassicAssert.AreEqual(1024, o.IntArray[0, 0]);
            o.IntArray[0, 0] = 1234;
            ClassicAssert.AreEqual(2468, f(o, 1));
            ClassicAssert.AreEqual(2468, o.IntArray[0, 0]);
            o.IntArray[0, 0] = 1;
            ClassicAssert.AreEqual(16, f(o, 100));
            ClassicAssert.AreEqual(16, o.IntArray[0, 0]);
            o.IntArray[0, 0] = -1234;
            ClassicAssert.AreEqual(-2468, f(o, 1));
            ClassicAssert.AreEqual(-2468, o.IntArray[0, 0]);
        ...
        public void Test2()
        {
            ...
            ClassicAssert.AreEqual(1024, f(o, 10));
            ClassicAssert.AreEqual(1024, o.NullableIntArray[0, 0]);
            o.NullableIntArray[0, 0] = 1234;
            ClassicAssert.AreEqual(2468, f(o, 1));
            ClassicAssert.AreEqual(2468, o.NullableIntArray[0, 0]);
            o.NullableIntArray[0, 0] = 1;
            ClassicAssert.AreEqual(16, f(o, 100));
            ClassicAssert.AreEqual(16, o.NullableIntArray[0, 0]);
            o.NullableIntArray[0, 0] = -1234;
            ClassicAssert.AreEqual(-2468, f(o, 1));
            ClassicAssert.AreEqual(-2468, o.NullableIntArray[0, 0]);
        ...
        public void Test4()
        {
            ...
            o.UIntArray[0, 0] = 1;
            ClassicAssert.AreEqual(1024, f(o, 10));
            ClassicAssert.AreEqual(1024, o.UIntArray[0, 0]);
            o.UIntArray[0, 0] = 1234;
            ClassicAssert.AreEqual(2468, f(o, 1));
            ClassicAssert.AreEqual(2468, o.UIntArray[0, 0]);
            o.UIntArray[0, 0] = 1;
            ClassicAssert.AreEqual(16, f(o, 100));
            ClassicAssert.AreEqual(16, o.UIntArray[0, 0]);
            o.UIntArray[0, 0] = 1;
            ClassicAssert.AreEqual(2147483648, f(o, 31));
            ClassicAssert.AreEqual(2147483648, o.UIntArray[0, 0]);
            ClassicAssert.AreEqual(0, f(null, 1));
        ...
        public void Test5()
        {
            ...
            ClassicAssert.AreEqual(1024, f(o, 10));
            ClassicAssert.AreEqual(1024, o.NullableUIntArray[0, 0]);
            o.NullableUIntArray[0, 0] = 1234;
            ClassicAssert.AreEqual(2468, f(o, 1));
            ClassicAssert.AreEqual(2468, o.NullableUIntArray[0, 0]);
            o.NullableUIntArray[0, 0] = 1;
            ClassicAssert.AreEqual(16, f(o, 100));
            ClassicAssert.AreEqual(16, o.NullableUIntArray[0, 0]);
            o.NullableUIntArray[0, 0] = 1;
            ClassicAssert.AreEqual(2147483648, f(o, 31));
            ClassicAssert.AreEqual(2147483648, o.NullableUIntArray[0, 0]);
            ClassicAssert.IsNull(f(null, 1));
