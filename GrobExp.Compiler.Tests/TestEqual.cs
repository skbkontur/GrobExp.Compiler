...
namespace GrobExp.Compiler.Tests
{
    ...
    public class TestEqual
    {
        ...
        public void Test1()
        {
            ...
            ClassicAssert.AreEqual(false, f(0, 1));
            ClassicAssert.AreEqual(true, f(1, 1));
        }
        ...
        public void Test4()
        {
            ...
            var f = LambdaCompiler.Compile(exp, CompilerOptions.All);
            ClassicAssert.AreEqual(false, f("zzz", "qxx"));
            ClassicAssert.AreEqual(true, f("zzz", "zzz"));
        }
        ...
        public void Test5()
        {
            ...
            var f = LambdaCompiler.Compile(exp, CompilerOptions.All);
            ClassicAssert.AreEqual(false, f(0, 1m));
            ClassicAssert.AreEqual(true, f(1, 1m));
        }
        ...
        public void Test6()
        {
            ...
            var f = LambdaCompiler.Compile(exp, CompilerOptions.All);
            ClassicAssert.AreEqual(false, f(TestEnum.Zero, TestEnum.One));
            ClassicAssert.AreEqual(true, f(TestEnum.One, TestEnum.One));
        }
        ...
        public void Test8()
        {
            ...
            var f = LambdaCompiler.Compile(exp, CompilerOptions.All);
            ClassicAssert.AreEqual(false, f(1));
            ClassicAssert.AreEqual(true, f(null));
        }
