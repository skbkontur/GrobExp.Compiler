...
namespace GrobExp.Compiler.Tests
{
    ...
    public class TestConstant
    {
        ...
        public void TestUShort()
        {
            ...
            var f = LambdaCompiler.Compile(exp, CompilerOptions.All);
            ClassicAssert.AreEqual(65500, f());
        }
        ...
        public void TestShort()
        {
            ...
            var f = LambdaCompiler.Compile(exp, CompilerOptions.All);
            ClassicAssert.AreEqual(-32000, f());
        }
        ...
        public void TestUInt()
        {
            ...
            var f = LambdaCompiler.Compile(exp, CompilerOptions.All);
            ClassicAssert.AreEqual(3500000000, f());
        }
        ...
        public void TestInt()
        {
            ...
            var f = LambdaCompiler.Compile(exp, CompilerOptions.All);
            ClassicAssert.AreEqual(-2000000000, f());
        }
        ...
        public void TestULong()
        {
            ...
            var f = LambdaCompiler.Compile(exp, CompilerOptions.All);
            ClassicAssert.AreEqual(ulong.MaxValue, f());
        }
        ...
        public void TestLong()
        {
            ...
            var f = LambdaCompiler.Compile(exp, CompilerOptions.All);
            ClassicAssert.AreEqual(long.MinValue, f());
        }
        ...
        public void TestFloat()
        {
            ...
            var f = LambdaCompiler.Compile(exp, CompilerOptions.All);
            ClassicAssert.AreEqual(float.Epsilon, f());
        }
        ...
        public void TestDouble()
        {
            ...
            var f = LambdaCompiler.Compile(exp, CompilerOptions.All);
            ClassicAssert.AreEqual(double.Epsilon, f());
        }
