...
namespace Compiler.Tests.AssignTests.MultiplyAssign
{
    ...
    public class TestSimpleArray
    {
        ...
        public void TestInt()
        {
            ...
            Assert.AreEqual(-20, o.IntArray[0]);
        ...
        public void TestNullable()
        {
            ...
            o.NullableIntArray[0] = -2;
            Assert.AreEqual(-20, f(o, 10));
            Assert.AreEqual(-20, o.NullableIntArray[0]);
        ...
        public void TestCheckedUnsigned()
        {
            ...
            Assert.AreEqual(4000000000, o.UIntArray[0]);
            o.UIntArray[0] = 2000000000;
        ...
        public void TestCheckedNullableUnsigned()
        {
            ...
            Assert.AreEqual(2, f(o, 2));
            Assert.AreEqual(2, o.NullableUIntArray[0]);
            o.NullableUIntArray[0] = 2000000000;
            Assert.AreEqual(4000000000, f(o, 2));
            Assert.AreEqual(4000000000, o.NullableUIntArray[0]);
            o.NullableUIntArray[0] = 2000000000;
            Assert.Throws<OverflowException>(() => f(o, 3));
            Assert.IsNull(f(null, 1));
